...
namespace Presentacion
{
    public partial class frmTrabajador : Form
    {
        ...
        public frmTrabajador()
        {
            ...
            this.ttMensaje.SetToolTip(this.cmbSexo, "seleccione e sexo del trabajador");
            this.ttMensaje.SetToolTip(this.dtFecha_nacimiento, "seleccione la fecha de nacimiento del trabajador");
            this.ttMensaje.SetToolTip(this.txtNum_documento, "Ingrese el numero de documento del trabajador");
            this.ttMensaje.SetToolTip(this.cmbAcceso, "seleccione el tipo de acceso del trabajador");
            this.ttMensaje.SetToolTip(this.txtUsuario, "Ingrese el nombre de usuario del trabajador");
            this.ttMensaje.SetToolTip(this.txtNombre, "Ingrese el password del trabajador");
        }
